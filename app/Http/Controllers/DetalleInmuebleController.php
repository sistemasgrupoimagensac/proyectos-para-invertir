    ...
    public function index(Request $request,$co_solicitud_prestamo){
        ...
        $detalle = DB::table('p_solicitud_prestamo')
                ...
                ->select(
                    ...
                    'datos_prestamo.motivo_prestamo', 'position_latitud_inmueble as latitud', 'position_longitud_inmueble as longitud',
        ...
        $like = MeInteresa::where(['co_prestamo'=> $detalle->co_prestamo,
